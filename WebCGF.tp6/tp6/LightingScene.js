...
LightingScene.prototype.init = function(application) {
	...
	this.boardA = new Plane(this, BOARD_A_DIVISIONS, -0.18,1.28,0.09,0.8);
	...
	this.floorAppearance.setSpecular(0,0.2,0.2,1);
	this.floorAppearance.setShininess(3);
	...
	this.windowAppearance.setShininess(3);
	...
	this.slidesAppearance.setSpecular(0,0.2,0.2,1);
	this.slidesAppearance.setShininess(3);
...
LightingScene.prototype.display = function() {
	...
	// Drone
	this.pushMatrix();
		this.translate(this.drone.movementX,this.drone.movementY,this.drone.movementZ);
		this.rotate(this.drone.rotationAngle * degToRad,0,1,0);
		this.drone.display();
	this.popMatrix();
